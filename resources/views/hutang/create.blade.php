        ...
        <div class="container">
            ...
            <form action="{{ route('hutangs.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select id="nokontrak" name="nokontrak" class="form-control" onchange="updatePetani()">
                        ...
                        @foreach ($kebuns as $kebun)
                            <option value="{{ $kebun->nomer_kontrak }}" data-petani="{{ $kebun->nama_petani }}">
                                {{ $kebun->nomer_kontrak }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="angsuran_sisa" name="angsuran_sisa" class="form-control" value="0"
                        readonly required>
                </div>
