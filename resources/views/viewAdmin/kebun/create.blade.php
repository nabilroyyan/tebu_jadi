...
<form action="/kebun-create" method="POST">
    @csrf
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group mb-4">
                ...
                <div class="form-group position-relative">
                    <input type="text" name="nama_kebun" class="form-control text-dark ps-5 h-58" placeholder="Enter Name">
        ...
        <div class="col-lg-6">
            <div class="form-group mb-4">
                ...
                <div class="form-group position-relative">
                    <input type="text" name="alamat" class="form-control text-dark ps-5 h-58" placeholder="Enter Name">
                    <i class="ri-user-line position-absolute top-50 start-0 translate-middle-y fs-20 text-gray-light ps-20"></i>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="form-group mb-4">
                ...
                <div class="form-group position-relative">
                    ...
                    />
                    <i class="ri-map-line position-absolute top-50 start-0 translate-middle-y fs-20 text-gray-light ps-20"></i>
                </div>
            </div>
        </div>
        {{-- <div class="col-lg-6">
        ...
        <div class="col-lg-6">
            <div class="form-group mb-4">
                ...
                <div class="form-group position-relative">
                    <input name="kecamatan" type="teks" name="kecamatan" class="form-control text-dark ps-5 h-58" placeholder="Enter Phone Number">
                    <i class="ri-phone-line position-absolute top-50 start-0 translate-middle-y fs-20 text-gray-light ps-20"></i>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="form-group mb-4">
                ...
                <div class="form-group position-relative">
                    <input name="kabupaten" type="teks" name="kabupaten" class="form-control text-dark ps-5 h-58" placeholder="Enter Phone Number">
                    <i class="ri-phone-line position-absolute top-50 start-0 translate-middle-y fs-20 text-gray-light ps-20"></i>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="form-group mb-4">
                ...
                <div class="form-group position-relative">
                    <input name="nama_petani" type="teks" name="nama_petani" class="form-control text-dark ps-5 h-58" placeholder="Enter Phone Number">
                    <i class="ri-phone-line position-absolute top-50 start-0 translate-middle-y fs-20 text-gray-light ps-20"></i>
                </div>
            </div>
        </div>
