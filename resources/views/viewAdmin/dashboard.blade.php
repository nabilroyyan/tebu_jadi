                    ...
                    <div class="stats-box card bg-white border-0 rounded-10 mb-4">
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <p class="fw-semibold">
                                    <span class="text-danger">1.3%</span> Down from past
                                    week
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="stats-box card bg-primary-div border-0 rounded-10 mb-4">
                        <div class="card-body p-4">
                            ...
                            <h3 class="body-font fw-bold fs-3 mb-1 text-white">
                                $12,875
                                <sub class="fw-normal"><i class="ri-arrow-up-s-fill"></i> 10%</sub>
                            </h3>
                ...
                <div class="card-body p-4">
                    <div class="d-sm-flex justify-content-between align-items-center">
                        <div class="flex-grow-1 mb-3 mb-sm-0">
                            ...
                            <h3 class="body-font fw-bold fs-24 mb-3">
                                8.14k <sub class="text-gray-light fw-normal">Review</sub>
                            </h3>
                            <div class="d-flex align-items-center">
                                ...
                                <p class="fw-semibold">
                                    <span class="text-body me-1">4.5</span>
                                    <span class="text-primary">+15.6%</span> From previous
                                    period
                                </p>
                            </div>
                        </div>
                    ...
                    <ul class="ps-0 mb-0 list-unstyled max-h-198" data-simplebar>
                        <li class="border-bottom border-color-gray mb-3 pb-3">
                            <div class="d-sm-flex justify-content-between align-content-center">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/user-1.jpg" class="rounded-circle wh-44"
                                            alt="user-1" />
                                    </div>
                        ...
                        <li class="border-bottom border-color-gray mb-3 pb-3">
                            <div class="d-sm-flex justify-content-between align-content-center">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/user-2.jpg" class="rounded-circle wh-44"
                                            alt="user-2" />
                                    </div>
                                    <div class="flex-grow-1 ms-10">
                        ...
                        <li>
                            <div class="d-sm-flex justify-content-between align-content-center">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/user-3.jpg" class="rounded-circle wh-44"
                                            alt="user-3" />
                                    </div>
                                    <div class="flex-grow-1 ms-10">
                    ...
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>02-12-2024</td>
                                <td>
                                    <span class="badge bg-danger bg-opacity-10 text-danger py-2 px-3 fw-semibold">Out of
                                        Stock</span>
                                </td>
                                <td>4.9 (55 Votes)</td>
                            </tr>
                ...
                <div class="d-sm-flex justify-content-between align-items-center text-center">
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination mb-0 mt-3 mt-sm-0 justify-content-center">
                            ...
                            <li class="page-item">
                                <a class="page-link active" href="index.html">1</a>
                            </li>
                            <li class="page-item">
                            ...
                            <table class="table align-middle">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection"
                                                class="__cf_email__"
                                                data-cfemail="076266746e6966756661667329606b62743e3f476d686e6b2964686a">[email&#160;protected]</a>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection"
                                                class="__cf_email__"
                                                data-cfemail="c8a4b1a7bda6affca997aba7a4a4a1a6bb88a2a7a1a4e6aba7a5">[email&#160;protected]</a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection"
                                                class="__cf_email__"
                                                data-cfemail="c2a4b0a3aca9f5a7fbfa82a8adabaeeca1adaf">[email&#160;protected]</a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection"
                                                class="__cf_email__"
                                                data-cfemail="aecbcfddc7c0cfdccfc8cfda80c9c2cbdd9796eec4c1c7c280cdc1c3">[email&#160;protected]</a>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                    ...
                    <ul class="ps-0 mb-0 list-unstyled max-h-406" data-simplebar>
                        <li class="border-bottom border-color-gray mb-3 pb-3">
                            <div class="d-sm-flex justify-content-between align-content-center">
                                <a href="product-details.html" class="d-flex align-items-center text-decoration-none">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/product-6.jpg" class="rounded-3 wh-54" alt="product-6" />
                                    </div>
                                    <div class="flex-grow-1 ms-10">
                        ...
                        <li class="border-bottom border-color-gray mb-3 pb-3">
                            <div class="d-sm-flex justify-content-between align-content-center">
                                <a href="product-details.html" class="d-flex align-items-center text-decoration-none">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/product-7.jpg" class="rounded-3 wh-54" alt="product-7" />
                                    </div>
                                    <div class="flex-grow-1 ms-10">
                                        <h4 class="fw-semibold fs-15 mb-0 text-body">
                                            Smart Watch F8 Pro
                        ...
                        <li class="border-bottom border-color-gray mb-3 pb-3">
                            <div class="d-sm-flex justify-content-between align-content-center">
                                <a href="product-details.html" class="d-flex align-items-center text-decoration-none">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/product-8.jpg" class="rounded-3 wh-54" alt="product-8" />
                                    </div>
                                    <div class="flex-grow-1 ms-10">
                                        <h4 class="fw-semibold fs-15 mb-0 text-body">
                                            Nord Fold ZL
                        ...
                        <li class="border-bottom border-color-gray mb-3 pb-3">
                            <div class="d-sm-flex justify-content-between align-content-center">
                                <a href="product-details.html" class="d-flex align-items-center text-decoration-none">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/product-9.jpg" class="rounded-3 wh-54" alt="product-9" />
                                    </div>
                                    <div class="flex-grow-1 ms-10">
                                        <h4 class="fw-semibold fs-15 mb-0 text-body">
                                            Wall Clock Cimbina
                        ...
                        <li class="mb-1">
                            <div class="d-sm-flex justify-content-between align-content-center">
                                <a href="product-details.html" class="d-flex align-items-center text-decoration-none">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/product-10.jpg" class="rounded-3 wh-54"
                                            alt="product-10" />
                                    </div>
                                    <div class="flex-grow-1 ms-10">
                                        <h4 class="fw-semibold fs-15 mb-0 text-body">
